...
PKG_SHORT="Sarg"			# -> pfSense-pkg-Sarg
PKG_TITLE="Sarg"			# name shown in the Package Manager
PKG_VERSION="1.1.0"
PKG_CATEGORY="www"
PKG_LICENSE="BSD2CLAUSE"
PKG_COMMENT="Squid Analysis Report Generator"
PKG_DESCR="Turns the Squid access log into per-user browsing reports."
PKG_CONFIGFILE="sarg.xml"
SRC_DIRNAME="sarg"
...
FILES_PKG="sarg.inc sarg.template sarg.xml sarg_schedule.xml sarg_sync.xml
	sarg_users.xml"
FILES_WWW="sarg.php sarg_about.php sarg_frame.php sarg_realtime.php
	sarg_reports.php sarg_sorttable.js"
FILES_PRIV="sarg.priv.inc"
FILES_BIN=""
