...
```sh
fetch -q -o - https://raw.githubusercontent.com/bootablearg/pfsense-packages-revived/main/samba-ad/install.sh | less
```

**O desde un clon**, que no necesita red para los archivos del paquete:

```sh
git clone https://github.com/bootablearg/pfsense-packages-revived.git
cd pfsense-packages-revived/samba-ad
...
los contribuyentes de pfsense-packages-revived. Ver [LICENSE](LICENSE).
