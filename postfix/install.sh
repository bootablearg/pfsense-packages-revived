...
PKG_SHORT="Postfix"			# -> pfSense-pkg-Postfix
PKG_TITLE="Postfix"			# name shown in the Package Manager
PKG_VERSION="1.1.0"
PKG_CATEGORY="mail"
PKG_LICENSE="APACHE20"
PKG_COMMENT="Postfix mail gateway and forwarder"
PKG_DESCR="Runs Postfix as a mail gateway in front of a real mail server: accepts SMTP, applies antispam and access policies, and relays on."
PKG_CONFIGFILE="postfix.xml"
SRC_DIRNAME="postfix"
...
LEGACY_NAMES="postfix"

FILES_PKG="postfix.inc postfix.xml postfix_acl.xml postfix_antispam.xml
	postfix_dkim.inc postfix_dmarc.inc postfix_domains.xml
	postfix_postfwd.inc postfix_postwhite.template postfix_recipients.xml
	postfix_sync.xml"
FILES_WWW="postfix.php postfix.sql.php postfix_about.php
	postfix_cloud_domains.php postfix_migrate_config.php
	postfix_queue.php postfix_recipients.php postfix_search.php
	postfix_view_config.php shortcuts/pkg_postfix.inc
	vendor/datatable/Buttons-1.2.4/css/buttons.dataTables.min.css
	vendor/datatable/Buttons-1.2.4/js/buttons.html5.min.js
	vendor/datatable/Buttons-1.2.4/js/dataTables.buttons.min.js
	vendor/datatable/ColReorder-1.3.2/js/dataTables.colReorder.min.js
	vendor/datatable/JSZip-2.5.0/jszip.min.js
	vendor/datatable/css/jquery.dataTables.min.css
	vendor/datatable/css/jquery.dataTables.postfix.css
	vendor/datatable/js/jquery.dataTables.postfix.js
	vendor/datatable/pdfmake-0.1.18/build/pdfmake.min.js
	vendor/datatable/pdfmake-0.1.18/build/vfs_fonts.js
	widgets/widgets/postfix.widget.php"
FILES_PRIV="postfix.priv.inc"
FILES_BIN="adexport.pl check_postfix_service.php mail_report.sh
	postfix_report.php sa-learn-pipe.sh"
