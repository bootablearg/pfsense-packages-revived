...
PKG_SHORT="E2guardian"			# -> pfSense-pkg-E2guardian
PKG_TITLE="E2guardian"			# name shown in the Package Manager
PKG_VERSION="1.1.0"
PKG_CATEGORY="www"
PKG_LICENSE="APACHE20"
PKG_COMMENT="Web content filter with per-group policies"
PKG_DESCR="Filters web traffic by content: inspects response bodies, phrases and MIME types, with different policies per group."
PKG_CONFIGFILE="e2guardian.xml"
SRC_DIRNAME="e2guardian"
...
LEGACY_NAMES="e2guardian"

FILES_PKG="e2guardian.conf.template e2guardian.inc e2guardian.xml
	e2guardian_antivirus.inc e2guardian_antivirus_acl.xml
	e2guardian_blacklist.xml e2guardian_config.xml
	e2guardian_content_acl.xml e2guardian_file_acl.xml
	e2guardian_groups.xml e2guardian_header_acl.xml e2guardian_ips.xml
	e2guardian_ips_header.template e2guardian_ldap.xml
	e2guardian_limits.xml e2guardian_log.xml e2guardian_phrase_acl.xml
	e2guardian_rc.template e2guardian_search_acl.xml
	e2guardian_site_acl.xml e2guardian_story.template e2guardian_sync.xml
	e2guardian_url_acl.xml e2guardian_users.xml
	e2guardian_users_footer.template e2guardian_users_header.template
	e2guardianfx.conf.template icapscan.conf.template pkg_e2guardian.inc"
FILES_WWW="e2gerror.php e2guardian.php e2guardian_about.php e2guardian_ldap.php
	e2guardian_log_parser.php e2guardian_logrotate.php
	e2guardian_monitor.php e2guardian_monitor_data.php
	e2guardian_scheds.php shortcuts/pkg_e2guardian.inc
	widgets/widgets/e2guardian.widget.php"
FILES_PRIV="e2guardian.priv.inc"
FILES_BIN=""
