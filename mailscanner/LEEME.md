...
Pasarela de filtrado de correo: envuelve SpamAssassin y ClamAV para analizar mensajes en busca de spam, virus y adjuntos no deseados. Para **pfSense CE 2.9 / Plus 26.x**.

*[English version: README.md](README.md)*

Revivido del paquete mailscanner de
...
`| sh -s install`, y abrir **Services → Mailscanner**.
