# Verification checklist — mailscanner
...
`mailscanner` is present in FreeBSD's official repository for this ABI, and
`install.sh check` resolves it and prints a coherent install plan (93 MiB).
